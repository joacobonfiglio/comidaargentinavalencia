...
export default async function handler(request, context) {
  ...
  if (path === "/") {
    enriched = enriched
      ...
      .replace('<div class="hn-rest-grid">', `<div class="hn-rest-grid">${viejoBarrioHomeCard}${donaPetronaHomeCard}${nativoOrigenHomeCard}${sanTelmoHomeCard}${entrecortesHomeCard}${papanatoHomeCard}${laVendettaHomeCard}${mobyDickHomeCard}${barVeniHomeCard}${cheTangoHomeCard}${cultureHomeCard}${laDiezHomeCard}${batarazaHomeCard}${parrilletaHomeCard}${gordonHomeCard}${newRestaurantHomeCard}`)
