...
export default async function handler(request, context) {
  ...
  const enriched = (fallbackImages[path] ? html.replace('src="undefined"', `src="${fallbackImages[path]}"`) : html)
    .replace("<h2>Una infografía rápida para elegir</h2>", `<h2>Una infografía rápida para elegir</h2><figure class="cuts-figure"><img src="${cutsInfographic}" alt="Infografía de cortes argentinos: vacío, bife de chorizo, ojo de bife, entraña, tira de asado y lomo"><figcaption>Mapa orientativo para leer una carta de parrilla con más contexto</figcaption></figure>`)
